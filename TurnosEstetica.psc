Algoritmo TurnosEstetica
	...
	Repetir
		Escribir '    '
		Escribir 'Elija el servicio que quiere consultar'
		Para j<-1 Hasta 6 Hacer
			Escribir j, '. ', servicios[j] // Aqui se muestra el menu de servicios, permitiendo al usuario elegir lo que desa realizar o averiguar el precio//
		FinPara
		...
		Según servicioElegido Hacer
			...
			4:// COSMETOLOGIA//
				...
				Si opcionCosmeto=3 Entonces
					...
					Si confirmacion=1 Entonces
						...
						Borrar Pantalla
						Escribir ' .................... '
						Escribir 'Su Turno para el asesoramiento de ', servicios[servicioElegido], ' se ha guardado exitosamente!'
						Escribir 'Para el dia: ', dias[diaElegido]
						Escribir 'A las: ', horasGabinete[horaElegida]
					FinSi
					Escribir ' .................... '
			...
			6:// REFLEXOLOGIA//
				Escribir 'Usted ha elgido ', servicios[servicioElegido]
				Escribir 'El servicio tiene un valor de $2800'
				Escribir 'Desea reservar un turno?'
				Escribir '1. Si' 
				Escribir '0. No'
				Leer confirmacion
